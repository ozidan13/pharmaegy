            ...
            <div className="bg-white shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  >
                    <div className="text-center">
                      <div className="text-green-600 font-medium">Payment Management</div>
                      <div className="text-sm text-gray-600 mt-1">Handle payment requests</div>
                    </div>
                  </Link>
                  ...
                  >
                    <div className="text-center">
                      <div className="text-yellow-600 font-medium">Wallet Management</div>
                      <div className="text-sm text-gray-600 mt-1">Manage system wallet</div>
                    </div>
                  </Link>
                  
                  <div className="bg-purple-50 p-4 rounded-lg">
                    <div className="text-center">
                      <div className="text-purple-600 font-medium">System Settings</div>
